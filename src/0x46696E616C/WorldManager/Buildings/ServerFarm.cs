...
namespace _0x46696E616C.Buildings
{
    ...
    {
        public ServerFarm(Game game, TextureValue texture, Vector2 position, TextureValue icon) : base(game, texture, position, icon)
        {
            Cost = new Wallet();
        ...
        {
            return new ServerFarm(game, tex, position, Icon);
        }
    }
}
