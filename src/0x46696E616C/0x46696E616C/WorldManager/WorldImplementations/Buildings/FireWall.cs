...
namespace _0x46696E616C.Buildings
{
    public class FireWall : Building, IResourceCharge
    {
        ...
        public FireWall(TextureValue texture, Vector2 position, TextureValue icon, WorldHandler world, ProjectileManager proj, Stats teamStats) : base(texture, position, icon, world, proj, teamStats)
        {
            Cost = new Wallet();
        ...
        {
            return new FireWall( tex, position, Icon, world, proj, teamStats);
        }
    }
}
